test_that("nndiagram_oversize works", {
  expect_equal(nndiagram_oversize(input=3,hidden = c(6,6),size.cutoff = 5), c( "% To make the code work in any LaTeX editor, users need to install and import two TeX packages in the setting, as shown below. ",
